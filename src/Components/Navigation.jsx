...
import cv from '../assets/doc/Femi_Fadiya_Segun Pelumi _ CV _sre_devops.pdf';
			...
			<div
				...
				<ul className='flex flex-col items-center self-center text-xl text-white my-[calc(90px*1.3)] '>
					...
					<a
						...
						target='_blank'
						rel='noreferrer'
						className='py-4 px-6 bg-[var(--secondary)] rounded-[10px] my-[24px] w-[90%] text-center font-[500] text-[var(--bg)] flex justify-center items-center gap-[16px]'>
						{' '}
						<MdCloudDownload size={25} />
						Download CV
					</a>

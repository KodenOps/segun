			...
			<div className='rights md:w-[45%] w-[100%] md:pl-[32px] md:ml-[0] md:mb-[0] mb-[50px] md:mt-[30px]'>
				...
				<div className='content w-full'>
					<p className=' px-[24px] md:px-[0] md:text-justify leading-[38px] my-[10px]'>
						...
						experiences that blend form and function. With expertise in UX
						design, I specialize in creating intuitive interfaces prioritizing
						user satisfaction. My process involves user research and empathy,
						using tools like Figma, and Figjam to visualize and iterate on
						design concepts. Proficient in web languages like HTML, CSS,
						Tailwind CSS, and React/NextJs, I bring designs to life efficiently.
						Additionally, I have a solid understanding of backend technologies
						like Linux, Bash scripting, Vagrants, and Docker. Currently, I work
						as a Site Reliability Engineer, focusing on ensuring system
						reliability and performance. I thrive in collaborative environments
						and am eager to innovate. Let's connect to bring your vision to
						life.
					</p>
					<div className='funfact w-[90%] mx-[5%] md:mx-[0] md:w-[100%]'>
						...
						<div className='topfact flex  justify-center gap-[32px] flex-wrap   mb-[32px] '>
							<Box
								...
								link='https://medium.com/@femifadiya.segun'
							/>
							<Box
								top='LinkedIn'
								bottom='Click to view'

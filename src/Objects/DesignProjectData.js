...
export const DesignProjectData = [
	{
		...
		gettingStartedTexts:
			'The process of this design exploration started with gathering information. Yes, I already have a problem in mind to tackle from personal experiences but this is not enough to base my judgement upon. One of the problems highlighted by the interviewed people is the ease of getting an apartment. One of the problems mention frequently during the survey and interview was extortion and lack of transparency when it comes into payment.',
		snoopAroundTexts:
			"How about seeing what other platforms are offering and see loopholes to fill. As at the time of brainstorming, I accessed PropertyPro & NigeriaPropertyCenter websites to see how they are tackling these issue. To some extent, I noticed the focus for these two sites is to just list out properties. What happen to the users afterwards is not their problem anymore. Also, there are no means of streamlining users-agent communication on the platform. Rather, they link them to the agent's whatsapp which are not always verified. This leads us back to the main security concerns.  ",
		solutionTexts: [
